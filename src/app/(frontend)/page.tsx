...
export default async function Home() {
  const excursions = await getExcursions() as Excursions[]
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Our guides are highly trained professionals with extensive knowledge of the area.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">We offer competitive prices without compromising the quality of your experience.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Choose the time that works best for you with our flexible booking options.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Thousands of happy travelers can't be wrong. Join us for an amazing adventure!</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Excursia offers unforgettable adventures in the Dominican Republic. We provide high-quality excursions with experienced guides.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#excursions" className="text-gray-400 hover:text-primary transition-colors">Excursions</a></li>
            ...
            <p className="text-gray-400">
              &copy; {new Date().getFullYear()} Excursia. All rights reserved.
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Beach Road, Punta Cana<br />Dominican Republic</p>
                  </div>
                </div>
